 ...
 *
 * <p>Implementa semántica de PATCH: todos los campos son opcionales. Solo los
 * campos con valor no nulo se aplican sobre el vehículo existente.</p>
 *
 * <p>No se permite modificar el modelo, el año de fabricación ni el tipo de
 * propulsión, ya que forman parte de la identidad estructural del vehículo.</p>
 *
